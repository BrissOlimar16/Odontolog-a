                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(layout.createSequentialGroup()
                                    .addComponent(lbPrecioVenta, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGap(18, 18, 18)
                                    .addComponent(txtPrecioVentaExterno, javax.swing.GroupLayout.PREFERRED_SIZE, 118, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(layout.createSequentialGroup()
                                    .addComponent(lbPrecioVenta1, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGap(18, 18, 18)
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        if (vacio()){
            JOptionPane.showMessageDialog(null, "Error: Hay un campo vacío");
                ...
                ") RETURNING Id_Producto)INSERT INTO precioproducto (Id_Producto, tipoCliente, Precio) SELECT Id_Producto, 'externo', "+txtPrecioVentaExterno.getText()+" "+
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        if (vacio()){
            ...
            insertarOmodificar("WITH producto_actualizado AS ( UPDATE producto SET Nombre = '" + txtInsumo.getText() + "', " +
             ...
             " WHEN tipoCliente = 'externo' THEN " + txtPrecioVentaExterno.getText() + "  WHEN tipoCliente = 'interno' THEN " + txtPrecioVentaInterno.getText() +
